...
void exportPlotManager(py::module_& m)
{
  py::class_<PlotManager>(m, "PlotManager")
    .def(py::init<>())
    .def("AddInputDataFiles", overload_cast<const string&, const vector<string>&>(&PlotManager::AddInputDataFiles), arg("inputIdentifier"), arg("inputFilePathList"))
    .def("AddInputDataFile", overload_cast<const string&, const string&>(&PlotManager::AddInputDataFile), arg("inputIdentifier"), arg("inputFilePath"))
    ...
    .def("AddColorPlot", &PlotManager::AddColorPlot, arg("plotName"), arg("figureGroup"), arg("colors") = vector<int32_t>{})
    .def("ClearDataBuffer", &PlotManager::ClearDataBuffer)
    .def("PrintLoadedPlots", &PlotManager::PrintLoadedPlots)
    .def("ExtractPlotsFromFile", &PlotManager::ExtractPlotsFromFile, arg("plotFileName"), arg("mode") = "load", arg("plotName") = ".*", arg("group") = ".*", arg("category") = ".*")
    .def("CreatePlots", overload_cast<const string&, const string&, vector<string>, const string&>(&PlotManager::CreatePlots), arg("figureGroup") = "", arg("figureCategory") = "", arg("plotNames") = vector<string>(), arg("outputMode") = "pdf")
    //.def("CreatePlot", overload_cast<const string&, const string&, const string&, const string&>(&PlotManager::CreatePlot), arg("name"), arg("figureGroup"), arg("figureCategory") = "", arg("outputMode") = "pdf")
    .def("DumpPlots", &PlotManager::DumpPlots, arg("plotFileName"), arg("figureGroup") = "", arg("plotNames") = vector<string>{})
    .def("DumpPlot", &PlotManager::DumpPlot, arg("plotFileName"), arg("figureGroup"), arg("plotName"))
    .def("SetOutputDirectory", &PlotManager::SetOutputDirectory, arg("path"))
    .def("SetUseUniquePlotNames", &PlotManager::SetUseUniquePlotNames, arg("useUniquePlotNames") = true)
...
void exportPlot(py::module_& m)
{
  py::class_<Plot>(m, "Plot")
    .def(py::init<const string&, const string&>(), arg("name"), arg("figureGroup"))
    .def(py::init<const string&, const string&, const optional<string>&>(), arg("name"), arg("figureGroup"), arg("plotTemplateName") = nullopt)
    ...
    .def("SetFigureCategory", &Plot::SetFigureCategory, arg("figureCategory"))
...
void exportPad(py::module_& m)
{
  py::class_<Pad>(m, "Pad")
    .def("Print", &Pad::Print)
    .def("AddData", overload_cast<const string&, const string&, const optional<string>&>(&Pad::AddData), arg("name"), arg("inputID"), arg("label") = nullopt, ref_int)
    ...
    .def("AddRatio", overload_cast<const string&, const string&, const string&, const string&, const optional<string>&>(&Pad::AddRatio), arg("numeratorName"), arg("numeratorInputID"), arg("denominatorName"), arg("denominatorInputID"), arg("label") = nullopt, ref_int)
    .def("AddRatio", overload_cast<const string&, const Data&, const string&, const string&, const optional<string>&>(&Pad::AddRatio), arg("numeratorName"), arg("numeratorLayout"), arg("denominatorName"), arg("denominatorInputID"), arg("label") = nullopt, ref_int)
    ...
    .def("AddRatio", overload_cast<const string&, const string&, const string&, const Data&, const optional<string>&>(&Pad::AddRatio), arg("numeratorName"), arg("numeratorInputID"), arg("denominatorName"), arg("denominatorLayout"), arg("label") = nullopt, ref_int)
...
void exportData(py::module_& m)
{
  py::class_<Data>(m, "Data")
    .def(py::init<>())
    .def(py::init<const string&, const string&, const optional<string>&>(), arg("name"), arg("inputID"), arg("label") = nullopt)
    .def("Print", &Data::Print)
    .def("AsRatio", &Data::AsRatio, ref_int)
    .def("GetInputID", &Data::GetInputID)
    .def("SetInputID", &Data::SetInputID, arg("inputID"), ref_int)
    ...
    .def("SetLegendID", &Data::SetLegendID, arg("legendID"), ref_int)
...
void exportRatio(py::module_& m)
{
  py::class_<Ratio, Data>(m, "Ratio")
    ...
    .def("GetInputID", [](const Ratio& self) -> const string& { return self.GetInputID(); })
    .def("SetInputID", [](Ratio& self, const string& inputID) -> Ratio& { return self.SetInputID(inputID); }, arg("inputID"), ref_int)
    ...
    .def("SetLegendID", [](Ratio& self, uint8_t id) -> Ratio& { return self.SetLegendID(id); }, arg("legendID"), ref_int)
