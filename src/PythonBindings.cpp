...
void exportPlotManager(py::module_& m)
{
  py::class_<PlotManager>(m, "PlotManager")
    ...
    .def("LoadPlots", &PlotManager::LoadPlots, arg("file"), arg("name") = ".+", arg("group") = ".+")
    .def("SavePlots", &PlotManager::SavePlots, arg("file"), arg("name") = ".+", arg("group") = ".+")
    .def("CreatePlots", &PlotManager::CreatePlots, arg("mode") = "pdf", arg("name") = ".+", arg("group") = ".+")
    .def("SetOutputDirectory", &PlotManager::SetOutputDirectory, arg("path"))
    .def("SaveProject", &PlotManager::SaveProject, arg("projectName"))
    .def_static("GetBasePlot", overload_cast<const string&, double_t>(&PlotManager::GetBasePlot), arg("name") = "1d", arg("screenResolution") = 100)
