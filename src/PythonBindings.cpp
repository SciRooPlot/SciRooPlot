...
void exportPlotManager(py::module_& m)
{
  py::class_<PlotManager>(m, "PlotManager")
    ...
    .def("SaveDatasets", &PlotManager::SaveDatasets, arg("datasetFile"))
    .def("LoadDatasets", &PlotManager::LoadDatasets, arg("datasetFile"))
    ...
    .def("LoadPlots", &PlotManager::LoadPlots, arg("plotFile"), arg("name") = ".+", arg("group") = ".+")
    .def("SavePlots", &PlotManager::SavePlots, arg("plotFile"), arg("name") = ".+", arg("group") = ".+")
    .def("GeneratePlots", &PlotManager::GeneratePlots, arg("mode") = "pdf", arg("name") = ".+", arg("group") = ".+")
...
void exportPlot(py::module_& m)
{
  py::class_<Plot>(m, "Plot")
    ...
    .def("Print", py::overload_cast<>(&Plot::Print))
    ...
    .def("SetName", &Plot::SetGroup, arg("name"), ref_int)
...
void exportPad(py::module_& m)
{
  py::class_<Pad>(m, "Pad")
    ...
    .def("AddRatio", overload_cast<const string&, const Data&, const string&, const string&, const optional<string>&>(&Pad::AddRatio), arg("numeratorName"), arg("numeratorSettings"), arg("denominatorName"), arg("denominatorDataset"), arg("label") = nullopt, ref_int)
    ...
    .def("AddRatio", overload_cast<const string&, const string&, const string&, const Data&, const optional<string>&>(&Pad::AddRatio), arg("numeratorName"), arg("numeratorDataset"), arg("denominatorName"), arg("denominatorSettings"), arg("label") = nullopt, ref_int)
